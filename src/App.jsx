  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-16 bg-[#05070a]/90 backdrop-blur-md border-b border-slate-800/80 px-6 flex items-center justify-between z-40 transition-colors">
      ...
      <div className="hidden md:flex items-center space-x-8 text-xs font-mono text-slate-400">
        ...
        {isAdmin && (
          <Link to="/admin" className="hover:text-cyan-400 transition flex items-center gap-1.5 font-bold text-cyan-400">
        ...
        {user ? (
          <div className="relative" ref={menuRef}>
            <button
              ...
              className="flex items-center gap-2.5 p-1.5 pr-3 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-200 transition"
            >
              <img
              ...
              <div className="hidden sm:flex flex-col text-left">
                ...
                <span className={`text-[10px] font-mono leading-none ${user.role === ROLES.ADMIN ? 'text-purple-400 font-bold' : 'text-emerald-400'}`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/auth"
              className="px-4 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold text-xs font-mono transition shadow-[0_0_15px_rgba(16,185,129,0.3)]"
            >
              Get Started
            </Link>
          </div>
