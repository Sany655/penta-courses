    ...
    <section className="py-20 bg-[#05070a] border-b border-slate-900 transition-colors" id="courses">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
          <div>
            <div className="text-xs font-mono text-emerald-400 uppercase tracking-widest mb-2 flex items-center gap-2 font-bold">
          ...
          <div className="font-mono text-xs text-slate-300 bg-slate-900 border border-slate-800 px-4 py-2 rounded-xl self-start md:self-auto flex items-center gap-2 shadow-sm">
            <span>Identity:</span>
