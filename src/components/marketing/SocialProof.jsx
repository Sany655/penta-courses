    ...
    <section className="py-20 bg-[#05070a] border-b border-slate-900 transition-colors">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="text-xs font-mono text-emerald-400 uppercase tracking-widest mb-2 font-bold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, idx) => (
            ...
            >
              <Quote className="w-8 h-8 text-slate-800 absolute top-6 right-6 pointer-events-none opacity-50" />
              ...
              <div className="pt-6 border-t border-slate-800/80 flex items-center space-x-3 mt-6">
                <img
                  src={t.avatar}
                  alt={t.name}
                ...
                <div>
                  ...
                  <div className="text-[11px] font-mono text-cyan-400 font-bold mt-0.5">{t.track}</div>
                </div>
              </div>
            </div>
          ))}
